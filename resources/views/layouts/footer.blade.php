<!-- Pie de página enlaces correspondienetes -->
    <div class="footer">
        ...
        <div class="footer-links">
            <!-- Enlaces de Servicios, agregar los enlaces necesarios -->
            ...
            <div class="footer-social-bar">
                ...
                <div class="footer-social-icon-container">
                    ...
                    <div class="footer-social-item">
                        <img class="footer-social-icon" src="assets/img/facebooks.svg" alt="Facebook" />
                        <div class="footer-social-text">Facebook</div>
                    </div>
                    <!-- Twitter -->
                    <div class="footer-social-item">
                        <img class="footer-social-icon" src="assets/img/twitters.svg" alt="Twitter" />
                        <div class="footer-social-text">Twitter</div>
                    </div>
                    <!-- Instagram -->
                    <div class="footer-social-item">
                        <img class="footer-social-icon" src="assets/img/instagrams.svg" alt="Instagram" />
                        <div class="footer-social-text">Instagram</div>
                    </div>
                    <!-- Youtube -->
                    <div class="footer-social-item">
                        <img class="footer-social-icon" src="assets/img/youtubes.svg" alt="Youtube" />
